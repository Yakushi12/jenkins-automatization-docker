...
cd ./jenkins-automatization-docker
...
ansible-playbook ../../Ansible/playbooks/nexus_playbook.yml   --vault-password-file="/Users/dzakharchenko/vpass" --tags="nexus-configure" --extra-vars '{"jenkins_url":"${jenkins_ip}"}'
ansible-playbook ../../Ansible/playbooks/jenkins_playbook.yml --vault-password-file="/Users/dzakharchenko/vpass" --tags="jenkins-configure" --extra-vars '{"nexus_url":"${nexus_ip}"}'
