...
module "google_compute_instance_secret" {
  ...
  secret_pair = {
    ...
    "mysql_root_name"     = var.mysql_user_name[0]
    "mysql_root_password" = var.mysql_user_password[0]
    "mysql_user_name"     = var.mysql_user_name[1]
    "mysql_user_password" = var.mysql_user_password[1]
  }
}
